...
### Concentration
In V3, concentrating liquidity within a specific price range to earn more fees.
...
### Fee Tier
The percentage of trading fees charged by a liquidity pool (V3).
...
### Tick
The minimum price granularity in V3 concentrated liquidity.
